...
//   let persent = input.indexOf(2021)
// console.log(persent)
...
//185
///////////////////////////////////////////
// only 2 number will add together to get 2021
// find the probuct of those 2 number
//e.g 1000 + 2021 output 1000 * 2021

for(let i = 0; i < input.length; i++){
    for(let j = i+1; j < input.length; j++){
        if(input[i] + input[j] === 2021) console.log(input[i] * input[j],input[i],input[j])
    }
}
//272020
///////////////////////////////////////////
// only 3 number will add together to get 2021
// find the probuct of those 3 number

for(let i = 0; i < input.length; i++){
    for(let j = i+1; j < input.length; j++){
        for(let k = j+1; k < input.length; k++){
            if(input[i] + input[j] + input[k] === 2021) console.log(input[i] * input[j] * input[k],input[i],input[j],input[k])
        }
    }
}
//261852160
//only 4 number will add together to get 2021 find them

for(let i = 0; i < input.length; i++){
    for(let j = i+1; j < input.length; j++){
        for(let k = j+1; k < input.length; k++){
            for(let l = k+1; l < input.length; l++){
                if(input[i] + input[j] + input[k] + input[l] === 2021) console.log(input[i],input[j],input[k],input[l])
